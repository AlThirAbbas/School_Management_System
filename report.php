...
?>
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">تقارير الرسوم
...
<fieldset class="scheduler-border" >
    <legend  class="scheduler-border">ابحث عن طالب </legend>
<form class="form-inline" role="form" id="searchform">
  <div class="form-group">
   ...
   <div class="form-group">
    <label for="email"> تاريخ الانضمام </label>
    <input type="text" class="form-control" id="doj" name="doj" >
  </div>
  
  <div class="form-group">
    <label for="email"> المرحلة الدراسية </label>
   ...
   <button type="button" class="btn btn-success btn-sm" style="border-radius:0%" id="find" > بحث </button>
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">فاتورة دفع الرسوم </h4>
        </div>
        <div class="modal-body" id="formcontent">
        
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-danger" style="border-radius:0%" data-dismiss="modal">اغلاق</button>
        </div>
      </div>
    </div>
  </div>
