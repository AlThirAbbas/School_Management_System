...
{
$errormsg = "<div class='alert alert-success'><a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>تم دفع الرسوم بنجاح  </div>";
}
...
?>
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">الرسوم  
...
display:none;
		...
		<div class="panel panel-default">
                        <div class="panel-heading">
                          <h3>
                            الطلاب الذين يجب عليهم دفع الرسوم 
                            </h3>
                        </div>
