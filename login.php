<?php
    ...
    {
    $error = 'اسم المستخدم او كلمة السر غير صحياً';
    }
         ...
         <div class="row ">
                ...
                <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 col-xs-10 col-xs-offset-1">
                            ...
                            <div class="panel-body" style="background-color: #E2E2E2; margin-top:70px; box-shadow: 5px 10px #888888;">
							  <h3 class="myhead">نظام ادارة رسوم المدارس</h3>
                                <form role="form" action="login.php" method="post">
									...
									<div class="form-group input-group">
                                     ...
                                     <button class="btn btn-success" style="border-radius:0%" type= "submit" name="login">تسجيل الدخول</button>
