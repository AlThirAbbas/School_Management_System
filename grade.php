...
{
$errormsg = "<div class='alert alert-success'> تمت إضافة المرحلة بنجاح</div>";
}else if(isset($_REQUEST['act']) && @$_REQUEST['act']=="2")
{
$errormsg = "<div class='alert alert-success'> تم التحديث بنجاح</div>";
}
else if(isset($_REQUEST['act']) && @$_REQUEST['act']=="3")
{
$errormsg = "<div class='alert alert-success'>تم الحذف  بنجاح</div>";
}
...
<head>
    ...
    <title>ادارة رسوم المدارس</title>
...
?>
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">المراحل الدراسية  
						<?php
						echo (isset($_GET['action']) && @$_GET['action']=="add" || @$_GET['action']=="edit")?
						' <a href="grade.php" class="btn btn-success btn-sm pull-right" style="border-radius:0%">العودة الى الخلف </a>':'<a href="grade.php?action=add" class="btn btn-danger btn-sm pull-right" style="border-radius:0%"><i class="glyphicon glyphicon-plus"></i> اضافة مرحلة دراسية جديدة </a>';
						?>
						</h1>
			...
			<script type="text/javascript" src="js/validation/jquery.validate.min.js"></script>
               ...
               <div class="panel panel-success">
                        <div class="panel-heading">
                           <?php echo ($action=="add")? "اضف مرحلة دراسية": "تعديل مرحلة دراسية"; ?>
                        </div>
						...
						<div class="form-group">
								<label class="col-sm-2 control-label" for="Old">المراحلة الدراسية </label>
								<div class="col-sm-10">
							...
							<div class="form-group">
								<label class="col-sm-2 control-label" for="Confirm"> ملاحظة</label>
								<div class="col-sm-10">
						...
						<div class="form-group">
								...
								<input type="hidden" name="action" value="<?php echo $action;?>">
									...
									<button type="submit" name="save" class="btn btn-success" style="border-radius:0%">اضافة </button>
								</div>
							</div>
